<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center text-sm text-gray-600 mb-4">
            ...
            <span class="text-gray-900">Tambah Film</span>
        </div>
        <h2 class="text-2xl font-bold text-gray-800">Tambah Film Baru</h2>
        <p class="text-gray-600 mt-1">Tambahkan informasi lengkap film yang akan ditayangkan</p>
    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        @if ($poster)
                            <div class="mt-4">
                                <p class="text-xs text-gray-600 mb-2 font-medium">Preview:</p>
