    ...
    <div class="p-3">
        <div class="mb-6">
            <div class="flex items-center text-sm text-gray-600 mb-4">
                ...
                <span class="text-gray-900">Edit Sutradara</span>
            </div>
            <h2 class="text-2xl font-bold text-gray-800">Edit Sutradara</h2>
            <p class="text-gray-600 mt-1">Perbarui informasi sutradara</p>
        </div>
            ...
            <form action="{{ route('admin.sutradara.update', $sutradara->id) }}"
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex-shrink-0">
                            <div id="preview-container">
                                @if($sutradara->foto_profil)
                                    <img src="{{ asset('storage/' . $sutradara->foto_profil) }}"
                        ...
                        <div class="flex-1">
                            ...
                            <p class="mt-1 text-xs text-gray-500">PNG, JPG, GIF maksimal 2MB. Kosongkan jika tidak ingin
                                mengubah foto</p>
                        </div>
                    </div>
                    @error('foto_profil')
                ...
                <div class="mb-4">
                    ...
                    <input type="text"
                           id="nama_sutradara"
                           name="nama_sutradara"
                           value="{{ old('nama_sutradara', $sutradara->nama_sutradara) }}"
                ...
                <div class="mb-6">
                    ...
                    <textarea id="biografi"
                              ...
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent @error('biografi') border-red-500 @enderror">{{ old('biografi', $sutradara->biografi) }}</textarea>
                    @error('biografi')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
