        ...
        <div class="mt-14">
                ...
                <div class="flex justify-between items-start">
                    <div>
                        <div class="flex items-center space-x-2 text-gray-600 mb-1">
                            ...
                            <span>/</span>
                            <span class="text-gray-900 font-medium">Tambah Genre</span>
                        </div>
                        <h1 class="text-3xl font-bold text-gray-900">Tambah Genre</h1>
                        <p class="mt-1 text-gray-600">Tambahkan genre film baru</p>
                    </div>
                </div>
            </div>

            <!-- Form Card (max-w-2xl supaya tidak melebar) -->
            <div class="bg-white rounded-lg shadow-sm p-6 max-w-2xl">
                <form wire:submit.prevent="save">
                    ...
                    <!-- Action Buttons – 100% sama seperti semua form admin lainnya -->
